          ...
          <div className="max-w-[900px] center py-10 max-lg:px-[5vw]">
            ...
            <div className="mx-auto max-w-7xl">
              <div className="hidden sm:block">
                <img src={adH} alt="Banner" className="w-728 h-90" />
              </div>
              <div className="sm:hidden">
                {/* Tamanho do banner para telas menores que 640px */}
                <img src={adH} alt="Banner" className="w-full" />
              </div>
            </div>
