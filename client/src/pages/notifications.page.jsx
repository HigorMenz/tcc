...
const Notifications = () => {
  ...
  let filters = ["Tudo", "Likes", "Comentários", "Respostas"];
  ...
  return (
    <div className=" ">
      <h1 className="max-md:hidden relative">Notificações Recentes</h1>

      <div className="my-8 md:flex gap-1  sm:flex-auto ">
        {filters.map((filtername, i) => {
          return (
            <button
              key={i}
              className={
                " sm:pl-8 md:py-2 sm:w-full mr-3 mt-3 sm:py-2  " +
      ...
      {notifications == null ? (
        ...
        <div className="flex flex-col ">
          {notifications.results.length ? (
            ...
            <NoDataMessage message="Nada por aqui..." />
          )}
